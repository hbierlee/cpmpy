...
class CPM_gurobi(SolverInterface):
    ...
    def __init__(self, name="gurobi", cpm_model=None, subsolver=None, verbose=False, encoding=Encoding.CPMPY, encode_obj=False, reduce=False, order=Order.INPUT, named=False, output_stats=False, short_channel=False, **kwargs):
        """
